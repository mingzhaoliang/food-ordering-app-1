...
export default function MainNavigation() {
	const { showHeaderBackground, activePage } = useAppSelector(state => state.navigation);
	...
	return (
		<div className={`max-md:hidden flex justify-between items-center transition-all duration-300 ${showHeaderBackground || activePage !== "home" ? "bg-white/80 backdrop-blur-sm shadow-md text-slate-800" : "bg-transparent text-white"}`}>
			<Logo />
