...
export default function MenuOverview() {
    return (
        <div id="menu-preview" className="px-2 xs:px-6 sm:px-10 md:px-20 mt-10 sm:mt-10 md:mt-14 lg:mt-20 flex flex-col gap-2 xs:gap-4 sm:gap-8 lg:gap-16 justify-center items-center">
