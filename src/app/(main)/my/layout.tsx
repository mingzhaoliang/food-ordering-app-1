...
export default function AccountPageLayout({ children }: { children: React.ReactNode }) {
    return (
        <div className="relative min-h-screen z-40 pt-16 xs:pt-20 md:pt-24 lg:pt-28 pb-16 space-y-2 md:space-y-4 transition-all bg-teal-600/10">
            <div className="mx-auto flex flex-col gap-4 max-xxs:mx-2 max-xs:mx-4 md:gap-3 md:grid md:grid-rows-[auto_1fr] md:grid-cols-[repeat(12,_1fr)] items-center md:items-start">
                <div className="md:row-start-1 md:col-start-4 md:col-end-[-2] pt-2 pb-4 md:pb-8 flex flex-col gap-4 text-slate-800">
                    <HeaderTitle />
                </div>
