export default function ContactPageLayout({ children }: { children: React.ReactNode }) {
	return (
		<div className="relative min-h-screen z-40 pt-20 xs:pt-24 md:pt-28 lg:pt-32 pb-16 px-4 xs:px-8 lg:px-12 space-y-2 md:space-y-4 transition-all bg-teal-600/5">
